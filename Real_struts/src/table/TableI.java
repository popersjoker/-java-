...
/*     */   protected String DFS(String str){
	return "\""+str+"\"";
}
...
/*     */ 	public String clearAll() {return "delete  from "+this.tableName;}
/*     */   
...
{
	return SQL.quy(this.getColStr(0),this.tableName,this.getWhereStr_(2)).replace("=", " like ");
}
/*     */ 
/*     */ 
/*     */   
